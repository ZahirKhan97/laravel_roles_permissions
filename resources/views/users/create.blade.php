<x-app-layout>
  <x-slot name="header">
    <div class="flex justify-between">
      ...
      <a href="{{ route('users.index') }}" class="bg-slate-700 text-white rounded-md px-3 py-2">Back</a>
    </div>
  </x-slot>
              ...
              <div class="p-6 text-gray-900">
                  <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div>
                      ...
                      <label class="text-lg font-medium" for="email">Password</label>
                      <div class="my-3">
                      ...
                      <label class="text-lg font-medium" for="email">Confirm Password</label>
                      <div class="my-3">
                      ...
                      <button class="bg-slate-700 hover:bg-slate-500 text-white rounded-md px-5 py-3">Submit</button>
                    </div>
                  </form>
              </div>
          </div>
