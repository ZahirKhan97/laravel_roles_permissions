              ...
              <div class="p-6 text-gray-900">
                  <form action="{{ route('articles.store') }}" method="POST">
                    ...
                    <div>
                      ...
                      <div class="my-3">
                        <input value="{{ old('title') }}" id="title" name="title" placeholder="Title" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                      </div>
                      @error('title')
                      ...
                      <div class="my-3">
                        <input value="{{ old('author') }}" id="author" name="author" placeholder="Author" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                      </div>
                      @error('author')
                       <p class="text-red-400 font-medium mb-2">{{ $message }}</p>
                      @enderror
